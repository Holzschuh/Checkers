...
#define PLAYER_COLOR_1 0.6f, 0.0f, 0.0f
#define PLAYER_COLOR_2 0.8f, 0.6f, 0.2f
#define TILE_BLACK 0.2f, 0.2f, 0.2f
#define TILE_WHITE 0.8f, 0.8f, 0.8f
#define TILE_SELECT 0.7f, 0.0f, 0.7f
#define TILE_SELECTED 0.7f, 0.7f, 0.0f
#define TILE_POSSIBLE_MOVES 0.0f, 0.8f, 0.8f
#define TRUE_BLACK 0.0f, 0.0f, 0.0f
